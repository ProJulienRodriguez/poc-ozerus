...
const CLIENTS_TREND = [294, 297, 301, 303, 305, 308, 310, 312, 314, 316, 317, 318];
const COUPON_TREND = [8.30, 8.28, 8.27, 8.25, 8.24, 8.22, 8.21, 8.20, 8.19, 8.18, 8.17, 8.17];
...
export const KPIS: Kpi[] = [
  ...
  { id: 'clients', label: 'Clients actifs', value: '318', delta: '+12', deltaTone: 'success', sub: 'vs. mois', spark: CLIENTS_TREND, sparkColor: 'var(--oz-navy)' },
  { id: 'coupon', label: 'Coupon moyen', value: '8,17', unit: '%', delta: '-0,1pt', deltaTone: 'warn', sub: '30j glissants', spark: COUPON_TREND, sparkColor: 'var(--oz-forest)' },
];
