...
export const PRODUCTS: Product[] = [
  {
    ...
    delta: '+0.42%', tone: 'success', issuer: 'BNP Paribas', currency: 'EUR',
  ...
  },
  {
    ...
    delta: '-1.08%', tone: 'danger', issuer: 'Société Générale', currency: 'EUR',
  ...
  },
  {
    ...
    delta: '+0.11%', tone: 'success', issuer: 'UBS', currency: 'USD',
  ...
  },
  {
    ...
    delta: '-0.05%', tone: 'neutral', issuer: 'Crédit Agricole CIB', currency: 'EUR',
  ...
  },
  {
    ...
    delta: '+0.28%', tone: 'success', issuer: 'UBS', currency: 'CHF',
  ...
  },
  {
    ...
    delta: '+0.18%', tone: 'success', issuer: 'Natixis', currency: 'EUR',
  ...
  },
  {
    ...
    delta: '-0.22%', tone: 'neutral', issuer: 'Deutsche Bank', currency: 'EUR',
